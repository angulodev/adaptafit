...
**Fase:** clasificación manual en curso — **126 de 895 (14,1%)** · lote 4 de ~12
...
| **Clasificación manual** | 126 de 895, lotes de 18, cola priorizada por valor | 🔄 **en curso** |
| **E2** — clasificación IA | Alternativa: 895 de una. USD 7,79 (3,89 con Batch API) | ⏸ listo, opcional |
| **Motor de filtrado** | Capas A/B/C + degradación. Probado sobre 126 | ✅ `engine.py` |
...
**Siguiente acción concreta:** lote 5 de clasificación (`workqueue.py --next 18`).
