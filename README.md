...
**Fase:** clasificación manual en curso — **234 de 895 (26,1%)** · lote 10 de ~12
...
| **Clasificación manual** | 234 de 895, lotes de 18, cola priorizada por valor | 🔄 **en curso** |
| **E2** — clasificación IA | Alternativa: 895 de una. USD 7,79 (3,89 con Batch API) | ⏸ listo, opcional |
| **Motor de filtrado** | Capas A/B/C + degradación. Probado sobre 234 | ✅ `engine.py` |
...
**Siguiente acción concreta:** lote 11 de clasificación (`workqueue.py --next 18`).
