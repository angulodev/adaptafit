...
**Fase:** clasificación manual en curso — **198 de 895 (22,1%)** · lote 8 de ~12
...
| **Clasificación manual** | 198 de 895, lotes de 18, cola priorizada por valor | 🔄 **en curso** |
| **E2** — clasificación IA | Alternativa: 895 de una. USD 7,79 (3,89 con Batch API) | ⏸ listo, opcional |
| **Motor de filtrado** | Capas A/B/C + degradación. Probado sobre 198 | ✅ `engine.py` |
...
**Siguiente acción concreta:** lote 9 de clasificación (`workqueue.py --next 18`).
