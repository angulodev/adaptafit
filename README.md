...
**Fase:** clasificación manual en curso — **630 de 895 (70,4%)** · lote 32
...
| **Clasificación manual** | 630 de 895, lotes de 18, cola priorizada por valor | 🔄 **en curso** |
| **E2** — clasificación IA | Alternativa: 895 de una. USD 7,79 (3,89 con Batch API) | ⏸ listo, opcional |
| **Motor de filtrado** | Capas A/B/C + degradación. Probado sobre 630 | ✅ `engine.py` |
...
**Siguiente acción concreta:** lote 33 de clasificación (`workqueue.py --next 18`).
