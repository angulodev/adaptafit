...
**Fase:** clasificación manual en curso — **396 de 895 (44,2%)** · lote 19
...
| **Clasificación manual** | 396 de 895, lotes de 18, cola priorizada por valor | 🔄 **en curso** |
| **E2** — clasificación IA | Alternativa: 895 de una. USD 7,79 (3,89 con Batch API) | ⏸ listo, opcional |
| **Motor de filtrado** | Capas A/B/C + degradación. Probado sobre 396 | ✅ `engine.py` |
...
**Siguiente acción concreta:** lote 20 de clasificación (`workqueue.py --next 18`).
