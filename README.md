...
**Fase:** clasificación manual en curso — **504 de 895 (56,3%)** · lote 25
...
| **Clasificación manual** | 504 de 895, lotes de 18, cola priorizada por valor | 🔄 **en curso** |
| **E2** — clasificación IA | Alternativa: 895 de una. USD 7,79 (3,89 con Batch API) | ⏸ listo, opcional |
| **Motor de filtrado** | Capas A/B/C + degradación. Probado sobre 504 | ✅ `engine.py` |
...
**Siguiente acción concreta:** lote 26 de clasificación (`workqueue.py --next 18`).
