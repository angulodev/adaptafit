...
**Fase:** clasificación manual en curso — **252 de 895 (28,2%)** · lote 11 de ~14
...
| **Clasificación manual** | 252 de 895, lotes de 18, cola priorizada por valor | 🔄 **en curso** |
| **E2** — clasificación IA | Alternativa: 895 de una. USD 7,79 (3,89 con Batch API) | ⏸ listo, opcional |
| **Motor de filtrado** | Capas A/B/C + degradación. Probado sobre 252 | ✅ `engine.py` |
...
**Siguiente acción concreta:** lote 12 de clasificación (`workqueue.py --next 18`).
